(function() {
  ...
  */ class RustfmtResult {
    ...
    function init(wasm_path) {
        ...
        let resultPromise;
        if (typeof WebAssembly.instantiateStreaming === 'function') resultPromise = WebAssembly.instantiateStreaming(fetchPromise, {
            './wasm_rustfmt': __exports
        });
        else resultPromise = fetchPromise.then((response)=>response.arrayBuffer()
...
//# sourceMappingURL=index.2d34dfe2.js.map
